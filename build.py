...
METHODS = [
    {
        ...
        "familyLabel": "原始 SBM",
        "color": "#3F6B8A",
        "note": "两投入、未经 Stage 2 环境调整的 CRS 基准。",
    },
    {
        "id": "raw_vrs",
        ...
        "familyLabel": "原始 SBM",
        "color": "#6B8DA6",
        "note": "两投入、未经 Stage 2 环境调整的 VRS 基准。",
    },
    {
        "id": "stage_base_crs",
        "column": "GPE_3stage_CRS_base",
        "label": "三阶段 SBM · 基准 CRS",
        "short": "3S-B-C",
        "family": "stage",
        "familyLabel": "三阶段 SBM",
        "color": "#087E72",
        "note": "不含疫情暴露项的 SFA 环境调整，CRS。",
    },
    {
        "id": "stage_base_vrs",
        "column": "GPE_3stage_VRS_base",
        "label": "三阶段 SBM · 基准 VRS",
        "short": "3S-B-V",
        "family": "stage",
        "familyLabel": "三阶段 SBM",
        "color": "#36A092",
        "note": "不含疫情暴露项的 SFA 环境调整，VRS。",
    },
    {
        "id": "stage_covid_crs",
        "column": "GPE_3stage_CRS_covid",
        "label": "三阶段 SBM · 疫情调整 CRS",
        "short": "3S-C-C",
        "family": "stage",
        "familyLabel": "三阶段 SBM",
        "color": "#075E59",
        "note": "含疫情暴露项的三阶段 SBM；当前普通 SBM 主结果。",
        "isMain": True,
    },
    {
        "id": "stage_covid_vrs",
        "column": "GPE_3stage_VRS_covid",
        "label": "三阶段 SBM · 疫情调整 VRS",
        "short": "3S-C-V",
        "family": "stage",
        "familyLabel": "三阶段 SBM",
        "color": "#5AB7A8",
        "note": "含疫情暴露项的三阶段 SBM，VRS。",
    },
    {
        "id": "super_covid_crs",
        "column": "GPE_3stage_SuperSBM_CRS_covid",
        "label": "三阶段 Super-SBM · 疫情调整 CRS",
        "short": "SS-C-C",
        "family": "super",
        "familyLabel": "Super-SBM",
        "color": "#D06645",
        "note": "在疫情调整 CRS 结果上区分效率前沿观测；当前 Super-SBM 主结果。",
        "isMain": True,
    },
    {
        "id": "super_covid_vrs",
        "column": "GPE_3stage_SuperSBM_VRS_covid",
        "label": "三阶段 Super-SBM · 疫情调整 VRS",
        "short": "SS-C-V",
        "family": "super",
        "familyLabel": "Super-SBM",
        "color": "#E08B68",
        "note": "在疫情调整 VRS 结果上区分效率前沿观测。",
    },
    {
        "id": "super_base_crs",
        "column": "GPE_3stage_SuperSBM_CRS_base",
        "label": "三阶段 Super-SBM · 基准 CRS",
        "short": "SS-B-C",
        "family": "super",
        "familyLabel": "Super-SBM",
        "color": "#B64D32",
        "note": "不含疫情项的三阶段 Super-SBM，CRS。",
    },
    {
        "id": "super_raw_crs",
        "column": "GPE_raw_SuperSBM_CRS_2input",
        "label": "原始 Super-SBM · CRS",
        "short": "SS-RAW",
        "family": "super",
        "familyLabel": "Super-SBM",
        "color": "#F0A17F",
        "note": "未经 Stage 2 调整的两投入 Super-SBM，CRS。",
    },
    {
...
def main() -> None:
    ...
    ordinary_alias_equal = np.allclose(
        ...
        pd.to_numeric(df["GPE_3stage_CRS_covid"]),
        equal_nan=True,
    )
    super_alias_equal = np.allclose(
        pd.to_numeric(df["gpe_main_y_supersbm"]),
        pd.to_numeric(df["GPE_3stage_SuperSBM_CRS_covid"]),
        equal_nan=True,
    )
    ...
    ordinary = pd.to_numeric(df["GPE_3stage_CRS_covid"])
    super_sbm = pd.to_numeric(df["GPE_3stage_SuperSBM_CRS_covid"])
    legacy = pd.to_numeric(df["GPE_CRS_selected"])
    base = pd.to_numeric(df["GPE_3stage_CRS_base"])
